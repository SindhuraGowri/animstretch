...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.text = new cjs.Text("Bad Guess", "30px 'Arial'", "#C6753D");
	this.text.textAlign = "center";
	...
	this.text_1 = new cjs.Text("Good Guess", "30px 'Arial'", "#C6753D");
	...
	// lost
	this.lost_word = new cjs.Text("Word is", "40px 'Arial'", "#242077");
	...
	this.text_2 = new cjs.Text("Word is", "40px 'Arial'", "#C6753D");
	...
	this.text_3 = new cjs.Text("YOU LOST", "80px 'Arial'", "#C6753D");
	...
	// won
	this.text_4 = new cjs.Text("This is a hangman game sample that is created using HTML5 Canvas document and can be published to  HTML5. The sample has Java Script code snippets for interactivity.", "13px 'Arial'", "#99FF99");
	this.text_4.lineHeight = 17;
	this.text_4.lineWidth = 975;
	this.text_4.parent = this;
	this.text_4.setTransform(2,-41);

	this.won_word = new cjs.Text("Word is", "40px 'Arial'", "#242077");
	...
	this.text_5 = new cjs.Text("Word is", "40px 'Arial'", "#C6753D");
...
// library properties:
lib.properties = {
	id: '073B2092B772D244BC1BA30F176F2F1F',
	width: 960,
	height: 640,
	fps: 24,
	color: "#F7E1AF",
...
an.compositions['073B2092B772D244BC1BA30F176F2F1F'] = {
